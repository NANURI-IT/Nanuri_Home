...
const historyData = [
  {
    year: "2026",
    items: [
      "삼성서울병원 Utol 개발 프로젝트(이노AX)",
      "유화증권 증권업무 고도화 구축",
      "휴레이포지티브 헬스케어 부문 협력 체결",
      "하나금융TI '우수협력사' 선정",
      "LG CNS 금융 IT Biz. Partner 선정",
      "하나증권 ITO운영 및 관리",
      "제주은행 종합수익관리 프로젝트",
      "미래에셋증권 연금차세대 시스템 진단컨설팅",
      "하나증권 발행어음 시스템 고도화개발 2차",
      "DB손해보험 업그레이드(이노룰스)",
      "한국투자증권 트레이딩 개발 업무계약",
    ],
  },
  {
    year: "2025",
    items: [
      "SK주식회사 외주 분야 Biz. Partner 선정",
      "삼성SDS 외주부문 입찰Pool 선정",
      "하나증권 발행어음 시스템 고도화 1차 개발",
      "우리투자증권 신 시스템 구축",
      "AIFSA 컴퓨터프로그램저작물 저작권등록",
      "하나증권 발행어음 시스템 안정화 구축",
      "한국투자증권 IMA 신규상품 업무개발 계약",
      "신한투자증권 Project Meta_Core 고유자산 구축",
      "하나증권 포인트서비스 및 제휴상품 입점 개발",
      "하나증권 자문 & 일임 플랫폼 & MTS 웹 개발",
      "하나증권원큐프로 MTS 재구축 대응개발",
      "한국투자증권 데이터 플랫폼 고도화",
      "한국투자증권 관리회계고도화 재무회계 IFRS9",
      "메리츠증권 대체거래소 대응 및 SOR 시스템 구축",
      "하나증권 자금세탁방지시스템(AML) 고도화",
      "현대차증권 차세대 시스템 구축",
      "하나증권 ITO 운영 및 기업여신 전산역무 개발",
      "한국저작권위원회 IBIMS IB통합관리시스템 등록",
      "하나은행 FIRST 하나원큐 비대면빠른서비스 구축",
      "하나증권 신용리스크 관리시스템 구축",
    ],
  },
  {
    year: "2024",
    items: [
      "주택도시보증공사 HUG 차세대 정보시스템 구축",
      "수출입은행 바젤III PSMOR 운영리스크 시스템 구축",
      "KB증권 리스크 심사 관리시스템(RAMS) 고도화",
      "하나증권 모바일 HR 정보시스템 개발",
      "하나은행·하나증권·현대차증권 금융투자소득 원천징수 시스템 구축",
      "하나증권 대체거래소 ATS시스템 개발",
      "하나금융TI 하나금융 퇴직연금 시스템 재구축",
      "KB증권 IB비즈니스 고도화 컨설팅",
      "SK주식회사 흥국생명 선심사 프로세스 개선사업",
      "한국투자증권 투자자산 통합관리 시스템 개발",
      "농협은행 개인투자용 국채판매대행 시스템 구축 (농협정보시스템)",
      "삼성SDS Finance IT Biz. Partner 선정",
    ],
  },
  {
    year: "2023",
    items: [
      "SK주식회사 하나증권 토큰증권(STO) 시스템 구축",
      "하나은행 SCB/JETCO 해외 ATM 출금서비스 구축",
      "하나증권 토큰증권(STO) 플랫폼 구축 (INF컨설팅)",
      "유한대학교 산학협력 협약 체결",
      "하나증권 스탁머니 서비스 개발 구축",
      "한국주택금융공사 공공 마이데이터 유통체계 구축",
      "우리은행 신IB영업지원시스템 구축 (DB.Inc)",
      "건설공제조합 B2B 연계시스템 보증시스템 개발",
      "하나은행 시니어 TV뱅킹 시범 사업 구축",
      "KB증권 IB/PI 투자심사 고도화 개발",
    ],
  },
  {
    year: "2022",
    items: [
      "하나증권 기업여신(IB/PI) 고도화 개발",
      "한화시스템 흥국생명 차세대 구축/대출 시스템 개발",
      "하나증권 국내주식 소수단위 거래 시스템 구축",
      "하나증권 제안 시스템 신규 구축",
      "하나금융TI OCIO 외부위탁운용 시스템 구축",
      "KB증권 리스크심사 관리시스템 구축",
      "하나금융투자 발행어음 관리시스템 개발",
    ],
  },
  {
    year: "2021",
    items: [
      ...
      "수출입은행 기업금융 자동심사 시스템 구축",
      "하나금융투자 발행 어음 시스템 구축 개발",
      "헬스케어 (주)휴레이포지티브 협력사 체결",
      "아토마인드 본임상 시험 플랫폼 구축 (휴레이포지티브)",
      "EMI 무릎재활치료 관리시스템 구축 (휴레이포지티브)",
      "KB국민은행 ECM 시스템 구축 개발",
      "한화생명 미수채권관리 시스템 구축",
      "NICE평가정보 기업 신용정보 WEB 서비스 구축",
  ...
  },
  {
    ...
    items: [
      "IB중계시스템 패키지 개발",
      "농협정보시스템 IT 협력사",
      "NH농협생명 투자금융지원 시스템 구축",
      "IB통합관리시스템 패키지 개발",
      "신용회복위원회 차세대 시스템 구축 개발",
      "과학기술인공제회 차세대 정보시스템 구축",
      "하나금융TI 기업여신시스템 구축",
      "신한은행 체불방지시스템 구축",
      "한국투자증권 IB/PI 기업여신 시스템 구축",
    ],
  },
  {
    year: "2013",
